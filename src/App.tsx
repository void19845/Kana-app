    ...
    <>
      <header className="app-header">
        ...
        <nav className="mode-tabs">
          <NavLink to="/study" className={({ isActive }) => `mode-tab ${isActive ? 'mode-tab--active' : ''}`}>
            Étude
          </NavLink>
          <NavLink to="/quiz"  className={({ isActive }) => `mode-tab ${isActive ? 'mode-tab--active' : ''}`}>
            Quiz
          </NavLink>
          <NavLink to="/stats" className={({ isActive }) => `mode-tab ${isActive ? 'mode-tab--active' : ''}`}>
            Stats
          </NavLink>
        </nav>
        ...
        {!isStats && (
          <div className="script-toggle">
            <span className={`script-label ${!isKatakana ? 'script-label--active' : ''}`}>Hiragana</span>
            <button
              className={`toggle-pill ${isKatakana ? 'toggle-pill--on' : ''}`}
              onClick={handleScriptToggle}
              title="Changer de script"
            />
            <span className={`script-label ${isKatakana ? 'script-label--active' : ''}`}>Katakana</span>
          </div>
        )}
      </header>
